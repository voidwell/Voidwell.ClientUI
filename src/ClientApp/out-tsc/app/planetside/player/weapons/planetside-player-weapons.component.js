...
var PlanetsidePlayerWeaponsComponent = (function () {
    function PlanetsidePlayerWeaponsComponent(planetsidePlayer) {
        var _this = this;
        ...
        planetsidePlayer.playerData.subscribe(function (data) {
            ...
            if (_this.playerData !== null) {
                _this.weaponStats = _this.playerData.weaponStats;
            }
        });
    }
    return PlanetsidePlayerWeaponsComponent;
}());
PlanetsidePlayerWeaponsComponent = __decorate([
    core_1.Component({
...
exports.PlanetsidePlayerWeaponsComponent = PlanetsidePlayerWeaponsComponent;
