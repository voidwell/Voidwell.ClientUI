...
var PlanetsideAlertVehiclesComponent = (function () {
    function PlanetsideAlertVehiclesComponent(combatEvent) {
        this.combatEvent = combatEvent;
    }
    PlanetsideAlertVehiclesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.combatEvent.event.subscribe(function (alert) {
            if (alert == null) {
                return;
            }
            _this.sort.sort({
            ...
            _this.dataSource = new TableDataSource(alert.log.stats.vehicles, _this.sort, _this.paginator);
        });
    };
    return PlanetsideAlertVehiclesComponent;
}());
__decorate([
    core_1.ViewChild(material_1.MatSort),
    __metadata("design:type", material_1.MatSort)
], PlanetsideAlertVehiclesComponent.prototype, "sort", void 0);
__decorate([
    core_1.ViewChild(material_1.MatPaginator),
    __metadata("design:type", material_1.MatPaginator)
], PlanetsideAlertVehiclesComponent.prototype, "paginator", void 0);
PlanetsideAlertVehiclesComponent = __decorate([
    core_1.Component({
...
exports.PlanetsideAlertVehiclesComponent = PlanetsideAlertVehiclesComponent;
    ...
    TableDataSource.prototype.getSortedData = function (data) {
        ...
        return data.sort(function (a, b) {
            ...
            switch (_this.sort.active) {
                case 'name':
                    _a = [a.vehicle.name, b.vehicle.name], propertyA = _a[0], propertyB = _a[1];
                    break;
                case 'kills':
