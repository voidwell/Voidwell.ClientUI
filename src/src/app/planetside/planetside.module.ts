...
import { ActivityPopulationCardComponent } from './worlds/world/activity/activity-population-card/activity-population-card.component';
...
@NgModule({
    declarations: [
        ...
        ActivityPopulationCardComponent,
